...
const _PLACEMENTS: Array[Dictionary] = [
	...
	{"view_id": ViewIds.Id.INN_F1, "def_id": "chair", "x": 14, "y": 8, "rotation": 0},
	{"view_id": ViewIds.Id.INN_F1, "def_id": "chair", "x": 15, "y": 8, "rotation": 0},
	{"view_id": ViewIds.Id.INN_F1, "def_id": "chair", "x": 14, "y": 10, "rotation": 0},
	{"view_id": ViewIds.Id.INN_F1, "def_id": "chair", "x": 15, "y": 10, "rotation": 0},
	{"view_id": ViewIds.Id.INN_F1, "def_id": "waiting_chair", "x": 6, "y": 13, "rotation": 0},
	{"view_id": ViewIds.Id.INN_F1, "def_id": "waiting_chair", "x": 7, "y": 13, "rotation": 0},
	{"view_id": ViewIds.Id.INN_F1, "def_id": "waiting_chair", "x": 11, "y": 13, "rotation": 0},
	{"view_id": ViewIds.Id.INN_F1, "def_id": "waiting_chair", "x": 12, "y": 13, "rotation": 0},
...
static func _try_place(entry: Dictionary) -> void:
	...
	if FurnitureService.can_place(origin, def_id, rotation):
		FurnitureService.place_furniture(origin, def_id, rotation, false)
